        ...
        >
            <div className="flex flex-col h-full max-w-[440px] mx-auto bg-white">
                ...
                <div className="flex-1 overflow-y-auto px-4 py-4">
                    ...
                    {/* Event Type Card */}
                    <div className="bg-white border border-gray-light rounded-[16px] p-4 mb-4 relative">
                        {/* Purple top border */}
                    ...
                    <div className="flex items-center border-t border-b border-gray-ultra-light">
                        ...
                        >
                            {copiedLink === "regular" ? "Copied!" : "Copy link"}
                        </button>
                        ...
                        <button
                            ...
                            className="flex-1 py-3 text-sm text-gray-dark hover:bg-gray-ultra-light transition-colors"
                        >
                            {copiedLink === "single-use" ? "Copied!" : "Copy single-use link"}
                        </button>
                        <div className="w-px h-6 bg-gray-light"></div>
                        <button
                            onClick={handleShare}
